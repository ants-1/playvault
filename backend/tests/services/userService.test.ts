...
describe("userService", () => {
  ...
  describe("updaterUser", () => {
    it("should update user successfully", async () => {
      ...
      const result = await userService.updaterUser(1, "John Updated", "john@example.com");
    ...
    it("should throw NotFoundError if user not found", async () => {
      ...
      await expect(userService.updaterUser(999, "Name", "email@test.com")).rejects.toThrow(
        "User not found."
      );
    });
    ...
    it("should throw ConflictError if email exists", async () => {
      ...
      await expect(userService.updaterUser(1, "Name", "existing@test.com")).rejects.toThrow(
  ...
  describe("updateUserPassword", () => {
    it("should update password successfully", async () => {
      const mockUser: User = { id: 1, name: "John", email: "john@example.com", password: "hashed-oldPass" } as User;
      ...
      const result = await userService.updateUserPassword(1, "oldPass", "newPass");
    ...
    it("should throw AuthenticationError if old password does not match", async () => {
      ...
      await expect(userService.updateUserPassword(1, "wrongOldPass", "newPass")).rejects.toThrow(
    ...
    it("should throw NotFoundError if user not found", async () => {
      ...
      await expect(userService.updateUserPassword(999, "oldPass", "newPass")).rejects.toThrow(
        "User not found."
      );
    });
  });
